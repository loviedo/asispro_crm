...
function generar_excel_emples(rows){
    ...
    rows.forEach(function(row) {
        ...
        worksheet.cell(i+1,2).string(String(row.nombres)).style(style);
        worksheet.cell(i+1,3).string(String(row.tel_movil)).style(style);
        ...
        worksheet.cell(i+1,7).string(String(formatear_fecha(row.fecha_nacimiento))).style(style);
        worksheet.cell(i+1,8).string(String(row.direccion)).style(style);
        worksheet.cell(i+1,9).number(Number(row.n_hijos)).style(style);
